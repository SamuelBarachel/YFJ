        ...
        <div>
          {!canEdit && (
            <div className="flex items-center gap-2 px-4 py-3 rounded-xl mb-5"
              ...
              <p className="text-xs font-semibold" style={{ color: '#4285f4' }}>
                Roster is managed by YFJ Chair, TC, and RC/Deacon.
              </p>
            </div>
          )}
                  ...
                  <div key={r.id} className="rounded-2xl overflow-hidden group"
                    ...
                    <div className="hidden md:grid grid-cols-12 gap-4 items-center px-5 py-4">
                      ...
                      <div className="col-span-3">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-lg flex items-center justify-center text-[10px] font-black flex-shrink-0"
                            style={{ background: 'linear-gradient(135deg,#9b72f3,#4285f4)', color: 'white' }}>
                            {getInitials(r.chair)}
                          </div>
                      ...
                      <div className="col-span-3">
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-lg flex items-center justify-center text-[10px] font-black flex-shrink-0"
                            style={{ background: 'linear-gradient(135deg,#d96570,#fbbc04)', color: 'white' }}>
                            {getInitials(r.secretary)}
                          </div>
                      ...
                      {canEdit && (
                        <div className="flex gap-2 pt-1">
                          ...
                          <button onClick={() => deleteRoster(r.id)}
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold"
                            style={{ background: 'rgba(217,101,112,0.12)', color: '#d96570' }}>
              ...
              <div className="section-card p-6 w-full max-w-lg my-8 animate-slide-up">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label color="#0dbfcf">Date *</Label>
                      <input type="date" className="yfj-input" value={rosterForm.date} onChange={e => setRosterForm({ ...rosterForm, date: e.target.value })} />
                    </div>
                    <div>
                      <Label color="#4285f4">Time (EST)</Label>
                      <input type="time" className="yfj-input" value={rosterForm.timeEST} onChange={e => setRosterForm({ ...rosterForm, timeEST: e.target.value })} />
                    </div>
                  </div>
                  <div>
                    <Label color="#9b72f3">Meeting Chair</Label>
                    <input className="yfj-input" placeholder="Full name of the chair..." value={rosterForm.chair} onChange={e => setRosterForm({ ...rosterForm, chair: e.target.value })} />
                  </div>
                  <div>
                    <Label color="#d96570">Secretary</Label>
                    <input className="yfj-input" placeholder="Full name of the secretary..." value={rosterForm.secretary} onChange={e => setRosterForm({ ...rosterForm, secretary: e.target.value })} />
                  </div>
              ...
              <div className="section-card p-6 md:p-8 w-full max-w-2xl my-6 animate-slide-up">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label color="#9b72f3">Meeting Type</Label>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      <Label color="#0dbfcf">Date</Label>
                      <input type="date" className="yfj-input" value={meetingForm.date} onChange={e => setMeetingForm({ ...meetingForm, date: e.target.value })} />
                    </div>
                    <div>
                      <Label color="#0dbfcf">Start</Label>
                      <input type="time" className="yfj-input" value={meetingForm.timeStart} onChange={e => setMeetingForm({ ...meetingForm, timeStart: e.target.value })} />
                    </div>
                    <div>
                      <Label color="#0dbfcf">End</Label>
                      <input type="time" className="yfj-input" value={meetingForm.timeEnd} onChange={e => setMeetingForm({ ...meetingForm, timeEnd: e.target.value })} />
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <Label color="#d96570">Status</Label>
